...
public class SerializeUtils implements RedisSerializer {
    ...
    public Object deserialize(byte[] bytes) throws SerializationException {
        ...
        try (ByteArrayInputStream byteStream = new ByteArrayInputStream(bytes); ObjectInputStream objectInputStream = new ObjectInputStream(byteStream)) {
