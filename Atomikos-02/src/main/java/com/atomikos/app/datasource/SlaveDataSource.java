...
import com.atomikos.app.config.UserDBConfig;
...
@Configuration
@MapperScan(basePackages = "com.atomikos.app.dao.user", sqlSessionTemplateRef  = "slaveSqlSessionTemplate")
public class SlaveDataSource {
    // 配置从数据源
    @Bean(name = "SlaveDB")
    public DataSource testDataSource(UserDBConfig slaveConfig) throws SQLException {
    ...
    public SqlSessionFactory masterSqlSessionFactory(@Qualifier("SlaveDB") DataSource dataSource) throws Exception {
        ...
        bean.setMapperLocations(new PathMatchingResourcePatternResolver()
                .getResources("classpath:mapper/user/SlaveMapper.xml"));
